(define (problem problem_h3) (:domain dungeons-of-dreadrock)
(:objects
        ;; Zombie and Walls
...
(:init  (player-alive)
        ...
        (zombie-at z1 t49)
        (enemy-interaction t49)
        (zombie-alive z1)
        (zombie-path-forward z1 t49 t41)
        (zombie-path-forward z1 t41 t33)
        (zombie-path-forward z1 t33 t25)
        (zombie-path-forward z1 t25 t17)
        (zombie-path-backward z1 t17 t25)
        (zombie-path-backward z1 t25 t33)
        (zombie-path-backward z1 t33 t41)
        (zombie-path-backward z1 t41 t49)  
        (zombie-path-forward-last z1 t17)
        (zombie-path-backward-last z1 t49)
        (zombie-forward z1)
        

        (zombie-at z2 t3)
        (enemy-interaction t3)
        (zombie-alive z2)
        (zombie-path-forward z2 t3 t11)
        (zombie-path-forward z2 t11 t19)
        (zombie-path-forward z2 t19 t27)
        (zombie-path-forward z2 t27 t35)
        (zombie-path-backward z2 t35 t27)
        (zombie-path-backward z2 t27 t19)
        (zombie-path-backward z2 t19 t11)
        (zombie-path-backward z2 t11 t3)
        (zombie-path-forward-last z2 t35)    
        (zombie-path-backward-last z2 t3)
        (zombie-forward z2)

        (zombie-at z3 t21)
        (enemy-interaction t21)
        (zombie-alive z3)
        (zombie-path-forward z3 t21 t22)
        (zombie-path-forward z3 t22 t23)
        (zombie-path-forward z3 t23 t24)
        (zombie-path-backward z3 t24 t23)
        (zombie-path-backward z3 t23 t22)
        (zombie-path-backward z3 t22 t21)
        (zombie-path-forward-last z3 t24)    
        (zombie-path-backward-last z3 t21)
        (zombie-forward z3)

        (zombie-at z4 t64)
        (enemy-interaction t64)
        (zombie-alive z4)
        (zombie-path-forward z4 t64 t56)
        (zombie-path-forward z4 t56 t48)
        (zombie-path-forward z4 t48 t40)
        (zombie-path-backward z4 t40 t48)
        (zombie-path-backward z4 t48 t56)
        (zombie-path-backward z4 t56 t64)
        (zombie-path-forward-last z4 t40)    
        (zombie-path-backward-last z4 t64)
        (zombie-forward z4)

        (zombie-at z5 t51)
        (enemy-interaction t51)
        (zombie-alive z5)
        (zombie-path-forward z5 t51 t52)
        (zombie-path-forward z5 t52 t53)
        (zombie-path-forward z5 t53 t54)
        (zombie-path-backward z5 t54 t53)
        (zombie-path-backward z5 t53 t52)
        (zombie-path-backward z5 t52 t51)
        (zombie-path-forward-last z5 t54)    
        (zombie-path-backward-last z5 t51)
        (zombie-forward z5)
