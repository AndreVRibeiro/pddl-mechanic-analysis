(define (problem problem_h5) (:domain dungeons-of-dreadrock)
(:objects
        ;; Zombies
...
(:init  (player-alive)
        ...
        (zombie-at z1 t57)
        (enemy-interaction t57)
        (zombie-alive z1)
        (zombie-path-forward z1 t57 t58)    
        (zombie-path-backward z1 t58 t57) 
        (zombie-path-forward-last z1 t58)    
        (zombie-path-backward-last z1 t57)
        (zombie-forward z1)

        (zombie-at z2 t39)
        (enemy-interaction t39)
        (zombie-alive z2)
        (zombie-path-forward z2 t39 t47)
        (zombie-path-forward z2 t47 t55)
        (zombie-path-forward z2 t55 t63)    
        (zombie-path-backward z2 t63 t55)
        (zombie-path-backward z2 t55 t47)
        (zombie-path-backward z2 t47 t39)
        (zombie-path-forward-last z2 t63)    
        (zombie-path-backward-last z2 t39)
        (zombie-forward z2)

        (zombie-at z3 t23)
        (enemy-interaction t23)
        (zombie-alive z3)
        (zombie-path-forward z3 t23 t24)    
        (zombie-path-backward z3 t24 t23) 
        (zombie-path-forward-last z3 t24)    
        (zombie-path-backward-last z3 t23)
        (zombie-forward z3)

        (zombie-at z4 t43)
        (enemy-interaction t43)
        (zombie-alive z4)
        (zombie-path-forward z4 t43 t51)
        (zombie-path-forward z4 t51 t59)
        (zombie-path-backward z4 t59 t51) 
        (zombie-path-backward z4 t51 t43) 
        (zombie-path-forward-last z4 t59)    
        (zombie-path-backward-last z4 t43)
        (zombie-forward z4)

        (zombie-at z5 t13)
        (enemy-interaction t13)
        (zombie-alive z5)
        (zombie-path-forward z5 t13 t14)
        (zombie-path-forward z5 t14 t15)
        (zombie-path-forward z5 t15 t16)    
        (zombie-path-backward z5 t16 t15)
        (zombie-path-backward z5 t15 t14)
        (zombie-path-backward z5 t14 t13)
        (zombie-path-forward-last z5 t16)    
        (zombie-path-backward-last z5 t13)
        (zombie-forward z5)

        (zombie-at z6 t44)
        (enemy-interaction t44)
        (zombie-alive z6)
        (zombie-path-forward z6 t44 t36)
        (zombie-path-forward z6 t36 t28)
        (zombie-path-forward z6 t28 t20)    
        (zombie-path-backward z6 t20 t28)
        (zombie-path-backward z6 t28 t36)
        (zombie-path-backward z6 t36 t44)
        (zombie-path-forward-last z6 t20)    
        (zombie-path-backward-last z6 t44)
        (zombie-forward z6)

        (zombie-at z7 t33)
        (enemy-interaction t33)
        (zombie-alive z7)
        (zombie-path-forward z7 t33 t34)
        (zombie-path-forward z7 t34 t35)
        (zombie-path-backward z7 t35 t34) 
        (zombie-path-backward z7 t34 t33) 
        (zombie-path-forward-last z7 t35)    
        (zombie-path-backward-last z7 t33)
        (zombie-forward z7)

        (zombie-at z8 t54)
        (enemy-interaction t54)
        (zombie-alive z8)
        (zombie-path-forward z8 t54 t53)
        (zombie-path-forward z8 t53 t52)
        (zombie-path-backward z8 t52 t53) 
        (zombie-path-backward z8 t53 t54) 
        (zombie-path-forward-last z8 t52)    
        (zombie-path-backward-last z8 t54)
        (zombie-forward z8)
           
        (zombie-at z9 t19)
        (enemy-interaction t19)
        (zombie-alive z9)
        (zombie-path-forward z9 t19 t18)
        (zombie-path-forward z9 t18 t17)
        (zombie-path-backward z9 t17 t18) 
        (zombie-path-backward z9 t18 t19) 
        (zombie-path-forward-last z9 t17)    
        (zombie-path-backward-last z9 t19)
        (zombie-forward z9)

        (zombie-at z10 t32)
        (enemy-interaction t32)
        (zombie-alive z10)
        (zombie-path-forward z10 t32 t31)
        (zombie-path-forward z10 t31 t30)
        (zombie-path-forward z10 t30 t29)    
        (zombie-path-backward z10 t29 t30)
        (zombie-path-backward z10 t30 t31)
        (zombie-path-backward z10 t31 t32)
        (zombie-path-forward-last z10 t29)    
        (zombie-path-backward-last z10 t32)
        (zombie-forward z10)

        (zombie-at z11 t7)
        (enemy-interaction t7)
        (zombie-alive z11)
        (zombie-path-forward z11 t7 t6)
        (zombie-path-forward z11 t6 t5)
        (zombie-path-forward z11 t5 t4)
        (zombie-path-forward z11 t4 t3)
        (zombie-path-forward z11 t3 t2)
        (zombie-path-forward z11 t2 t1)    
        (zombie-path-backward z11 t1 t2)
        (zombie-path-backward z11 t2 t3)
        (zombie-path-backward z11 t3 t4)
        (zombie-path-backward z11 t4 t5)
        (zombie-path-backward z11 t5 t6)
        (zombie-path-backward z11 t6 t7)
        (zombie-path-forward-last z11 t1)    
        (zombie-path-backward-last z11 t7)
        (zombie-forward z11)
